...
#intialized the values for car, bus, rail, EV, and carbon neutral modes of transport
...
totalDis = kmCar + kmBus + kmRail + kmCarbonNull + kmEV
...
actualCO2 = (car * kmCar) + (bus * kmBus) + (rail * kmRail) + (neutral * kmCarbonNull) + (EV * kmEV)
